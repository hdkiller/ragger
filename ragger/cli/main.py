...
def main() -> None:
    ...
    index_parser.add_argument("--append", action="store_true", help="Append without replacing the workspace")
    ...
    if args.command == "search":
        print(json.dumps(manager.search_workspace(workspace=args.workspace, query=args.query, k=args.k), indent=2))
